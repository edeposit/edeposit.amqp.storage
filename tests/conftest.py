...
# Fixtures ====================================================================
@pytest.fixture(scope="session", autouse=True)
def alt_settings_path(zeo):
    global ALT_SETTINGS_PATH

    if not ALT_SETTINGS_PATH:
        ALT_SETTINGS_PATH = _create_alt_settings()
